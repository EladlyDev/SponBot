...
state([
    ...
    'fellows' => User::when(function ($query) {
                        return $query->where('country_code', auth()->user()->country_code)
                            ->orWhereIn('preferred_languages', explode(', ', auth()->user()->preferred_languages));
                    })
            ...
            <div class="p-4 md:w-1/2 w-full border-[.7px] bg-white rounded-lg shadow-md dark:bg-gray-700 dark:border-s-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                <div class="flex items-center">
                    ...
                    <div class="w-4/5">
                        ...
                        <button @if (!$fellow->sponsee_limit > 0 || auth()->user()->sponsee_limit !== 0) style="visibility:hidden" @endif type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Request
